  ...
  return (
    <>
      ...
      <div className="w-full h-full bg-[#00509d]">
        <Header />
        <div>
          <div className="flex flex-col space-y-12 px-12 py-3 tablet:px-24 tablet:py-12 desktop:px-80 desktop:py-24">
            <div>
              <h1 className="desktop:text-center font-black text-4xl tablet:text-5xl desktop:text-8xl text-white">
                Descubre las metodologias de desarrollo de software
              </h1>
        ...
        <div className="bg-gradient-to-r from-[#0F2027] to-[#2C5364]">
          <div className="flex flex-col space-y-6 px-12 py-3 tablet:px-24 tablet:py-12 desktop:px-80 desktop:py-24"></div>
        </div>
      </div>
    </>
  )
